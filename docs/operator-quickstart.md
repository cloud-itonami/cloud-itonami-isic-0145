# Operator Quickstart — Swine-Farm Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0145** (`cloud-itonami-isic-0145`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0145.git
cd cloud-itonami-isic-0145
```
...
- Blueprint governor key: `swine-farm-operations-governor`
- Likely source path: `swineops.governor.cljc`
